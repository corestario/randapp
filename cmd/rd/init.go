...
import (
	...
	rcfg "github.com/corestario/randapp/x/randapp/config"
...
func InitCmd(ctx *server.Context, cdc *codec.Codec, mbm module.BasicManager,
	...
	cmd.Flags().String(clientFlags.FlagChainID, "", "genesis file chain-id, if left blank will be randomly created")
